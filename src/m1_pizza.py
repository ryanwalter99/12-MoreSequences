...
def run_test_polygon():
    ...
    window = rg.RoseWindow(600, 400, title)

    circle = rg.Circle(rg.Point(175, 215), 90)
    circle.outline_thickness = 7
    polygon(window, circle, 4, 'green', 12)
...
def run_test_fancy_polygon():
    ...
    circle = rg.Circle(rg.Point(200, 155), 110)
    circle.fill_color = 'green'
    fancy_polygon(window, circle, 45, 6, 'purple', 4)
    window.close_on_mouse_click()
