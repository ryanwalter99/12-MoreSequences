...
def rectangles_from_circles(circles):
    ...
    for circle in circles:
        rectangle = rg.Rectangle(rg.Point(circle.center.x+circle.radius,circle.center.y+circle.radius),
                                 rg.Point(circle.center.x-circle.radius,circle.center.y-circle.radius))
        seq = seq + [rectangle]
    return seq
